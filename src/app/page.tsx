...
const main = async () => {
  ...
  // save data on page evaluate in adpData array
...
// boiler plate nextJS homepage html function
// main() will run on page load/ reload to run again
